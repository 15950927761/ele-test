    ...
    <div class="shop-header">
      ...
      <div class="shop-content">
        ...
        <div class="header-content">
          <h2 class="content-title" @click="showModal = !showModal">
      ...
      <div class="shop-header-discounts" @click="showModal2 =!showModal2">
      ...
      <div class="shop-brief-modal" v-if="showModal">
        <div class="brief-modal-content">
          ...
          <ul class="brief-modal-msg">
            ...
            <li><h3>滴滴专送</h3><p>约 {{info.deliveryTime}} 分钟</p></li>
            <li><h3>{{info.deliveryPrice}} 元</h3><p>配送费用</p></li>
            <li><h3>{{info.distance}}</h3><p>距离</p></li>
          </ul>
          <h3 class="brief-modal-title"><span>公告</span></h3>
          <div class="brief-modal-notice">
            {{info.bulletin}}
          </div>
          <div class="mask-footer" @click="showModal=!showModal">
            <span class="iconfont icon-guanbi"></span>
          </div>
        </div>
        <div class="brief-modal-cover"></div>
      </div>
      <div class="activity-sheet" v-if="showModal2">
        <div class="activity-sheet-content">
          <h2 class="activity-sheet-title">优惠活动</h2>
          <ul class="list">
            <li class="activity-item" :class="{'activity-green':support.type==0,'activity-red':support.type==1,'activity-orange':support.type==2,}" v-for="(support,index) in info.supports">
                <span class="content-tag">
          ...
          <div class="activity-sheet-close" @click="showModal2 = !showModal2">
            <span class="iconfont icon-guanbi"></span>
          </div>
        </div>
...
.shop-header{
  ...
  .shop-nav{
    ...
    padding:5px 10px;
    position:relative;
    background:url("../../common/img/ead54394c3de198d3e6d3e9111bbfpng.png");
    &::before{
      content:"";
      position:absolute;
      left:0;
...
.shop-content{
  ...
  .header-content{
    ...
    .content-title{
      ...
      .content-tag{
        border-radius:2px;
        background-image:linear-gradient(90deg,#fff100,#fff339);
        width:36px;
        height:18px;
        line-height:18px;
        margin-right:10px;
